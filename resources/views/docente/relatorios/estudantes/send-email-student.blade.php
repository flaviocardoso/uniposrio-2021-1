...
<form method="post" enctype="multipart/form-data">
    <fieldset style='background:rgba(255,255,255,0.6);'><legend>Enviar Mensagem</legend>
        <input name="docente[nome_aluno]" type="text" id="docente[nome_aluno]" value="<?php echo isset($resultado['nome_aluno'])?$resultado['nome_aluno']:NULL; ?>" size="50" readonly>
        <input name="docente[email_aluno]" type="text" id="docente[email_aluno]" value="<?php echo isset($resultado['email_aluno'])?$resultado['email_aluno']:NULL; ?>" size="24" readonly><br>
