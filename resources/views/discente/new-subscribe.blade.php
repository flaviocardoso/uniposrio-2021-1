...
@section('content')
<p><b>Cadastro de particitantes</b></p>
<form action="" method="post" enctype="multipart/form-data" name="form_novaInscricao">
    <p>
      <input name="discente[login]" type="text" title="Nome de usuário" placeholder="login" size="30" value="" required>
    </p>
    <p>
      <input type="hidden" name="discente[salt]" id="discente[salt]" value="<?php echo crypt('uniposrio',date('sih')); ?>">
      <input name="discente[senha]" type="password" title="Senha" placeholder="senha" size="30" value="" required>
    </p>
    <p>
      <input name="discente[nome_aluno]" type="text" title="Escreva o seu nome" placeholder="nome completo" size="50" value="" required>
    </p>
    <p>
      <input name="discente[email_aluno]" title="Email" type="email" placeholder="e-mail" size="20" value="" required>
      <input type="hidden" name="discente[dt_cadastro_aluno]" value="<?php echo date('Y-m-d h:i:s'); ?>">
    </p>
    ...
    <p>
      <span class="formElement" aria-label="EUF/Nota">
        <input name="discente[euf]" type="text" title="EUF" id="discente[euf]" placeholder="Digite aqui seu número EUF" size="40" value="" onKeyUp="return txtBoxFormat(this, '9999999999', event);" required>
        <br><input name="discente[nota]" type="number" title="Nota" placeholder="Digite aqui sua nota" size="20" value=""  min="0.00" max="10.00" step="0.01" required></br>
      </span>
    </p>
    <p>
      <span class="formElement" aria-label="Categoria">
        <select name="discente[categoria]" title="Programa" class="formElement" required>
...
<p>
    <input type="radio" name="discente[nacionalidade_aluno]" title="Nacionalidade" id="discente[nacionalidade_aluno]" value="B" onClick="chkNacionalidade('discente[cpf_aluno]', 'discente[passaporte_aluno]');">
    <label>Brasileiro/Brazilian</label>
    <input type="radio" name="discente[nacionalidade_aluno]" title="Nacionalidade" id="discente[nacionalidade_aluno]" value="E" onClick="chkNacionalidade('discente[passaporte_aluno]', 'discente[cpf_aluno]');">
    <label>Estrangeiro/Foreign</label>
    <span class="formElement" aria-label="CPF/Passport">
    <input name="discente[cpf_aluno]" type="text" id="discente[cpf_aluno]" placeholder="CPF" size="20" value="" onKeyPress="return txtBoxFormat(this, '999.999.999-99', event);" onKeyUp="validaCPF(this.name);" title="CPF">
...
<select name="discente[area_atuacao_aluno]" onChange="insertOther(this.value, 'newAreaAtuacao');">
	<option></option>
    <option value="1">OUTRO - Entre no sistema e cadastre sua área de atuação / OTHER - Enter the system and register your area of expertise</option>
</select></span>
<p>
...
<span class="formElement" aria-label="Instituto de Conclusão/Host Institution">
  <select name="discente[inst_conclu_aluno]" class="formElement" onChange="addNewField(this.value, 'instSigla','instNome');">
    ...
    <option value="1">OUTRO - Entre no sistema e cadastre sua instituição  / OTHER - Enter the system and register your institution</option>
    </select>
</span>
</p><p>
<!-- <span class="formElement" aria-label="Instituto de Conclusão/Host Institution">
...
<p>
    ...
    <input type="hidden" name="discente[status]" value="2">
    <input type="hidden" name="discente[token]" value="">
  
    <p>
      <input type="submit" name="bt_salvarNovaInscricao" id="bt_salvarNovaInscricao" value="Salvar">
      <!-- <input type="submit" name="button" id="button" value="Login"> -->
    </p>
    <br/> 
    <p>Obs.: Caso sua <b>Área de Atuação</b>, ou sua instituição de ensino não estejam listados acima.  <br/>Clique em "<b>Outros</b>", conclua seu cadastro e na guia de <b>Inscrição</b>, cadastre sua <b>Área de Atuação</b> e/ou <b>Instituição de Ensino.</b></p>
